...
function start() {
    ...
    return new RSVP.Promise(function(resolve, reject) {
        ...
        // Assume iface.requestCollection makes a request to /start and returns a promise that
        ...
        iface.requestCollection()   // TODO can the /start request fail because canControl is false?
...
function stop() {
    ...
    return new RSVP.Promise(function(resolve, reject) {
        ...
        resolve(iface.stopCollection().then(waitForCollectionStop));
    });
}
